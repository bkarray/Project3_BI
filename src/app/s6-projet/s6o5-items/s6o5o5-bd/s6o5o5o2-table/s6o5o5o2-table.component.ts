...
@Component({
  selector: 'app-s6o5o5o2-table',
  templateUrl: './s6o5o5o2-table.component.html',
  styleUrls: ['./s6o5o5o2-table.component.css']
})
export class S6o5o5o2TableComponent implements OnInit, OnChanges {
