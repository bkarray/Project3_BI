...
@Component({
  selector: 'app-s8o1o1o1-cmdcenterdetail',
  templateUrl: './s8o1o1o1-cmdcenterdetail.component.html',
  styleUrls: ['./s8o1o1o1-cmdcenterdetail.component.css']
})
export class S8o1o1o1CmdcenterdetailComponent implements OnInit {
  ...
  TS_GetData_From_File_CommandCenter_Tab(): void {  
    this.S8o8o5ServicecenterService.TS_Sce_Detect_id_Tab_From_CmdC_To_CmdCenterDetail().subscribe(data => {
      this.id_1 = data.id_1 
      if (this.id_1 === '8_Post_Data_From_CmdCenterDetail_2') {
        this.id_1 = '8_Post_Data_From_CmdCenterDetail_3'
        console.log('8.2 - FileCmdCenter - From CmdC to CmdCenterDetail - TS_Sce_Detect') 
  ...
  TS_PostData_To_File_CmdC(): void {
    ...
    this.S8o8o5ServicecenterService.TS_Sce_SendData_id_Tab_From_CmdCenterDetail_To_CmdC(Data_Interface)
  
  }

  TS_CmdCenterDetail_ButtonClick_Return(): void {
    this.id_1 = '9_Post_Data_From_CmdCenterDetail_Return_1'
    this.TS_PostData_To_File_CmdC()
  }
